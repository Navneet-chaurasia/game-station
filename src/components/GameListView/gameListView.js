/**
 * This component shows some informatoin in list form inside a card
 * this can be used to showcase recently played games by user in list form along with recent score
...
<article className="leaderboard">
  ...
  <header>
    ...
    <h1 className="leaderboard__title"><span className="leaderboard__title--top">Recently Played</span></h1>
  </header>
